...
int main()
{
  ...
  //my_short2 became a negative after adding one because it overflowed due to
  // it's largest number being 32767. my_int2 did not become negative because
  // it can have a larger integer .
